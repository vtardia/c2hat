...
/**
 * Implements Quick Sort on a list
 * Shamefully copied and adapted from
 * https://www.flipcode.com/archives/Quick_Sort_On_Linked_List.shtml
 * by Stephen Hassall (www.logic22.com)
